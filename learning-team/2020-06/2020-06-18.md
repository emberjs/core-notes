...
Some concerns were raised about removing the production asset filter, and rwj suggested the idea of generating the component in-repo.
We briefly discussed that idea in a previous call, and I want to dig in a bit more.
