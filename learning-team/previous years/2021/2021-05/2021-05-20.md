...
- https://github.com/emberjs/ember.js/pull/19489
- https://github.com/emberjs/ember.js/pull/19490

Action: Do the same as we did for RSVP.

### Create Ember Data landing page (API Docs)
PR: https://github.com/ember-learn/ember-api-docs/pull/746

JW: the ticket was scoped to writing the content.
JW: I was hoping it would be easy to make it actually show but it wasn't the case.
JW: I need help getting the page showing with fastboot.

Action: Help JW get it running.

Update: Done by JW and CT in https://github.com/ember-learn/ember-api-docs/pull/761.
### ember-json-api-docs
